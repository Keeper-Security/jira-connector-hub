              ...
              <div className="setup-section">
                ...
                <div className="setup-docker-box">
                  ...
                  <code className="setup-docker-code">
                    docker run -d -p 9009:9009 keeper-commander service-create -p 9009 -c 'record-add,list,ls,get,record-type-info,record-update,share-record,share-folder,rti,record-permission,kd-list,kd-get,kd-record-add,kd-record-update,kd-share-folder,kd-share-record,kd-record-permission,epm,service-status' -f json -rm foreground -q y --user your@email.com --password yourpassword
                  </code>
                  ...
                  <code className="setup-docker-code">
                    docker run -d -p 9009:9009 keeper-commander service-create -p 9009 -c 'record-add,list,ls,get,record-type-info,record-update,share-record,share-folder,rti,record-permission,kd-list,kd-get,kd-record-add,kd-record-update,kd-share-folder,kd-share-record,kd-record-permission,epm,service-status' -f json -rm foreground -q y -ng &lt;ngrok-auth-token&gt; -cd &lt;custom-domain&gt; --user your@email.com --password yourpassword
                  </code>
                  ...
                  <code className="setup-docker-code">
                    docker run -d -p 9009:9009 keeper-commander service-create -p 9009 -c 'record-add,list,ls,get,record-type-info,record-update,share-record,share-folder,rti,record-permission,kd-list,kd-get,kd-record-add,kd-record-update,kd-share-folder,kd-share-record,kd-record-permission,epm,service-status' -f json -rm foreground -q y -cf &lt;cloudflare-tunnel-token&gt; -cfd &lt;cloudflare-custom-domain&gt; --user your@email.com --password yourpassword
                  </code>
...
this-device timeout 30d`}
                  ...
                  <code className="setup-cli-code">
                    keeper service-create -p=9009 -c="record-add,list,ls,get,record-type-info,record-update,share-record,share-folder,rti,record-permission,kd-list,kd-get,kd-record-add,kd-record-update,kd-share-folder,kd-share-record,kd-record-permission,epm,service-status" -rm="foreground" -q=y -f=json
                  </code>
